...
export default class BassTabBuddy extends Plugin {
	...
	async onload() {
		...
		this.addSettingTab(new BassBuddySettingsTab(this.app, this));
...
interface BassTabBuddySettings {
    mySetting: string;
    templatePath: string;
}

const DEFAULT_SETTINGS: BassTabBuddySettings = {
    mySetting: 'default',
    templatePath: ''
}

class BassBuddySettingsTab extends PluginSettingTab {
    plugin: BassTabBuddy;
    ...
    display(): void {
        ...
        new Setting(containerEl)
            .setName('Tablature Template')
            .setDesc('Specify a template for the Add Template button')
            .addText(text => text
                .setPlaceholder('templates/bass-tab-template.md')
